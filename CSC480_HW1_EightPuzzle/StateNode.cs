...
namespace CSC480_HW1_EightPuzzle
{
    public class StateNode  
    {
        ...
        public int CostOfMovesFromStart = 0;
        //public int TotalCostAllMoves = 0;
        public int ArrayStateInt = 0;
        ...
        public static int HashConvertToInt(int[] array)
        {
            int hashFromInt = 0;
            hashFromInt = array[0] * 100000000 + array[1] * 10000000 + array[2] * 1000000 + array[3] * 100000 + array[4] * 10000 + array[5] * 1000 + array[6] * 100 + array[7] * 10 + array[8];
            return hashFromInt;
        }
